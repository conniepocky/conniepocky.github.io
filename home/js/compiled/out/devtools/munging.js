...
var o37754 = temp__5455__auto__;
var temp__5455__auto____$1 = (o37754["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o37755 = temp__5455__auto____$1;
return (o37755["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__28105__auto__ = f;
return (o__28105__auto__["toString"]).call(o__28105__auto__);
} else {
return "";
}
}catch (e37756){var _ = e37756;
return "";
}});
...
try{var o__28105__auto___37758 = t;
(o__28105__auto___37758["cljs$lang$ctorPrWriter"]).call(o__28105__auto___37758,t,writer);
}catch (e37757){var __37759 = e37757;
}
...
var char_code = (function (){var o__28105__auto__ = (new String(char$));
return (o__28105__auto__["charCodeAt"]).call(o__28105__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__28105__auto__ = String;
return (o__28105__auto__["fromCharCode"]).call(o__28105__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__37760 = num_code;
switch (G__37760) {
case (1):
return (185);
...
var o__28105__auto__ = String;
return (o__28105__auto__["fromCharCode"]).call(o__28105__auto__,superscript_code);
});
/**
...
}catch (e37762){var _e__28112__auto__ = e37762;
return false;
}})())){
...
var vec__37763 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__37763,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o37766 = temp__5455__auto__;
var temp__5455__auto____$1 = (o37766["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o37767 = temp__5455__auto____$1;
return (o37767["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__37770){
var vec__37771 = p__37770;
var ns_detector = cljs.core.nth.call(null,vec__37771,(0),null);
...
var G__37777 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__37778 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__37777;
remaining_tokens = G__37778;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq37768){
var G__37769 = cljs.core.first.call(null,seq37768);
var seq37768__$1 = cljs.core.next.call(null,seq37768);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37769,seq37768__$1);
});
...
var vec__37782 = cljs.core.split_with.call(null,(function (p1__37781_SHARP_){
return cljs.core.not_EQ_.call(null,p1__37781_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__37782,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__37782,(1),null);
...
var vec__37785 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__37785,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__37785,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__37788 = cljs.core.rest.call(null,remaining_tokens);
var G__37789 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__37788;
name_tokens = G__37789;
continue;
} else {
...
var vec__37792 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__37792,(0),null);
var arity = cljs.core.nth.call(null,vec__37792,(1),null);
var vec__37795 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__37795,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__37795,(1),null);
var vec__37798 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__37798,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__37798,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__37798,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__37798,(3),null);
...
var vec__37804 = result;
var munged_ns = cljs.core.nth.call(null,vec__37804,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__37804,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__37804,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__37804,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__37804,(4),null);
var arity = cljs.core.nth.call(null,vec__37804,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__37808 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__37808,(0),null);
var args = cljs.core.nth.call(null,vec__37808,(1),null);
var vec__37811 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__37811,(0),null);
var name = cljs.core.nth.call(null,vec__37811,(1),null);
...
var G__37814 = (arity + (1));
var G__37815 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__37816){
var vec__37817 = p__37816;
var arity = cljs.core.nth.call(null,vec__37817,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__37817,(1),null);
...
return cljs.core.get.call(null,arities,p1__37820_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__37821_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___37828 = arguments.length;
var i__4500__auto___37829 = (0);
while(true){
if((i__4500__auto___37829 < len__4499__auto___37828)){
args__4502__auto__.push((arguments[i__4500__auto___37829]));

var G__37830 = (i__4500__auto___37829 + (1));
i__4500__auto___37829 = G__37830;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__37824){
var vec__37825 = p__37824;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__37825,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq37822){
var G__37823 = cljs.core.first.call(null,seq37822);
var seq37822__$1 = cljs.core.next.call(null,seq37822);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37823,seq37822__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__37833__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__37833__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__37833__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__37833__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__37834 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__37834,(0),null);
var fn_name = cljs.core.nth.call(null,vec__37834,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__37834,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__37834,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__37834,(4),null);
var arity = cljs.core.nth.call(null,vec__37834,(5),null);
...
var o__28105__auto__ = f;
return (o__28105__auto__["getBasis"]).call(o__28105__auto__);
});
/**
...
}catch (e37838){var _e__28112__auto__ = e37838;
...
var G__37839 = (obj[cljs.core.first.call(null,path)]);
var G__37840 = cljs.core.rest.call(null,path);
obj = G__37839;
path = G__37840;
continue;
} else {
...
return (function (accum,p__37841){
var vec__37842 = p__37841;
var bit = cljs.core.nth.call(null,vec__37842,(0),null);
var protocol = cljs.core.nth.call(null,vec__37842,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__37845){
var vec__37846 = p__37845;
var ns = cljs.core.nth.call(null,vec__37846,(0),null);
var name = cljs.core.nth.call(null,vec__37846,(1),null);
var selector = cljs.core.nth.call(null,vec__37846,(2),null);
...
return (function (p__37850){
var vec__37851 = p__37850;
var munged_name = cljs.core.nth.call(null,vec__37851,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__37851,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__37851,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__37849_SHARP_){
return (obj[cljs.core.first.call(null,p1__37849_SHARP_)]);
});})(name,sorted_matches,vec__37851,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1564480786588
