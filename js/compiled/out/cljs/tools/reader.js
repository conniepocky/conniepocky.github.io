...
var G__24484 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__24484;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__24485 = rdr;
...
if(("\\" === ch__$1)){
var ch_24486__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_24486__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_24486__$2);
} else {
}

var G__24487 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__24487;
continue;
}
}
...
var vec__24495 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24495,(0),null);
var start_column = cljs.core.nth.call(null,vec__24495,(1),null);
...
var G__24498 = cljs.core.conj_BANG_.call(null,a,form);
a = G__24498;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__24499 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__24500 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__24500;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__24499;
}});
/**
...
var vec__24507 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24507,(0),null);
var start_column = cljs.core.nth.call(null,vec__24507,(1),null);
...
var vec__24510 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24510,(0),null);
var end_column = cljs.core.nth.call(null,vec__24510,(1),null);
...
var vec__24513 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24513,(0),null);
var start_column = cljs.core.nth.call(null,vec__24513,(1),null);
...
var vec__24516 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24516,(0),null);
var end_column = cljs.core.nth.call(null,vec__24516,(1),null);
...
var sb = (function (){var G__24519 = (new goog.string.StringBuffer());
G__24519.append(initch);
...
var G__24521 = (function (){var G__24520 = sb;
G__24520.append(ch);

return G__24520;
})();
var G__24522 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__24521;
ch = G__24522;
continue;
}
...
switch (G__24525) {
case "\\":
var G__24529 = (function (){var G__24526 = sb;
G__24526.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__24526;
})();
var G__24530 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24529;
ch = G__24530;
continue;
...
break;
default:
var G__24531 = (function (){var G__24527 = sb;
G__24527.append(ch);

return G__24527;
})();
var G__24532 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24531;
ch = G__24532;
continue;
...
var vec__24536 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24536,(0),null);
var column = cljs.core.nth.call(null,vec__24536,(1),null);
...
var vec__24541 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24541,(0),null);
var column = cljs.core.nth.call(null,vec__24541,(1),null);
...
var vec__24546 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24546,(0),null);
var column = cljs.core.nth.call(null,vec__24546,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__24551 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24551,(0),null);
var start_column = cljs.core.nth.call(null,vec__24551,(1),null);
...
var vec__24554 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24554,(0),null);
var end_column = cljs.core.nth.call(null,vec__24554,(1),null);
...
var G__24557 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__24557,true,null,opts,pending_forms);
...
var G__24558 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__24558)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__24558)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__24558)){
...
var _STAR_suppress_read_STAR__orig_val__24559 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24560 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24560;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24559;
}});
...
var G__24561 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__24561,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__24561,rdr,first_line);
...
var G__24566 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__24565;
finished = G__24566;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__24567 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24568 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24568;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24567;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__24569 = cljs.tools.reader.arg_env;
var arg_env_temp_val__24570 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__24570;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__24571 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24571,"(");
...
var G__24572 = (i + (1));
var G__24573 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__24569;
}});
/**
...
var G__24575 = cljs.core.next.call(null,s__$1);
var G__24576 = ret;
s__$1 = G__24575;
r = G__24576;
continue;
...
var G__24577 = cljs.core.next.call(null,s);
var G__24578 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__24577;
key_vals = G__24578;
continue;
} else {
...
var gensym_env_orig_val__24582 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__24583 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__24583;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__24582;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__24584 = token;
var G__24584__$1 = (((G__24584 == null))?null:cljs.core.subs.call(null,G__24584,(1)));
var G__24584__$2 = (((G__24584__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24584__$1));
var G__24584__$3 = (((G__24584__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24584__$2));
var G__24584__$4 = (((G__24584__$3 == null))?null:cljs.core.symbol.call(null,G__24584__$3));
if((G__24584__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__24584__$4);
}
})():(function (){var G__24585 = token;
var G__24585__$1 = (((G__24585 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24585));
if((G__24585__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24585__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__24596,reader){
...
var eof = cljs.core.get.call(null,map__24597__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4730__auto___24605 = arguments.length;
var i__4731__auto___24606 = (0);
while(true){
if((i__4731__auto___24606 < len__4730__auto___24605)){
args__4736__auto__.push((arguments[i__4731__auto___24606]));

var G__24607 = (i__4731__auto___24606 + (1));
i__4731__auto___24606 = G__24607;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq24603){
var G__24604 = cljs.core.first.call(null,seq24603);
var seq24603__$1 = cljs.core.next.call(null,seq24603);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24604,seq24603__$1);
});


//# sourceMappingURL=reader.js.map?rel=1611747931353
