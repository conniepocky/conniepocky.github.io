...
var o23059 = temp__5718__auto__;
var temp__5718__auto____$1 = (o23059["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o23060 = temp__5718__auto____$1;
return (o23060["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22171__auto__ = f;
return (o__22171__auto__["toString"]).call(o__22171__auto__);
} else {
return "";
}
}catch (e23061){var _ = e23061;
return "";
}});
...
try{var o__22171__auto___23063 = t;
(o__22171__auto___23063["cljs$lang$ctorPrWriter"]).call(o__22171__auto___23063,t,writer);
}catch (e23062){var __23064 = e23062;
}
...
var char_code = (function (){var o__22171__auto__ = (new String(char$));
return (o__22171__auto__["charCodeAt"]).call(o__22171__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22171__auto__ = String;
return (o__22171__auto__["fromCharCode"]).call(o__22171__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23065 = num_code;
switch (G__23065) {
case (1):
return (185);
...
var o__22171__auto__ = String;
return (o__22171__auto__["fromCharCode"]).call(o__22171__auto__,superscript_code);
});
/**
...
}catch (e23067){var _e__22178__auto__ = e23067;
return false;
}})())){
...
var vec__23068 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23068,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o23071 = temp__5718__auto__;
var temp__5718__auto____$1 = (o23071["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o23072 = temp__5718__auto____$1;
return (o23072["nameToPath"]);
} else {
return null;
}
} else {
...
var G__23081 = (i__4731__auto___23080 + (1));
i__4731__auto___23080 = G__23081;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23075){
var vec__23076 = p__23075;
var ns_detector = cljs.core.nth.call(null,vec__23076,(0),null);
...
var G__23082 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23083 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23082;
remaining_tokens = G__23083;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23073){
var G__23074 = cljs.core.first.call(null,seq23073);
var seq23073__$1 = cljs.core.next.call(null,seq23073);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23074,seq23073__$1);
});
...
var vec__23087 = cljs.core.split_with.call(null,(function (p1__23086_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23086_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23087,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23087,(1),null);
...
var vec__23093 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23093,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23093,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23096 = cljs.core.rest.call(null,remaining_tokens);
var G__23097 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23096;
name_tokens = G__23097;
continue;
} else {
...
var vec__23100 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23100,(0),null);
var arity = cljs.core.nth.call(null,vec__23100,(1),null);
var vec__23103 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23103,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23103,(1),null);
var vec__23106 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23106,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23106,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23106,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23106,(3),null);
...
var vec__23112 = result;
var munged_ns = cljs.core.nth.call(null,vec__23112,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23112,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23112,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23112,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23112,(4),null);
var arity = cljs.core.nth.call(null,vec__23112,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__23116 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__23116,(0),null);
var args = cljs.core.nth.call(null,vec__23116,(1),null);
var vec__23119 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23119,(0),null);
var name = cljs.core.nth.call(null,vec__23119,(1),null);
...
var G__23122 = (arity + (1));
var G__23123 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23124){
var vec__23125 = p__23124;
var arity = cljs.core.nth.call(null,vec__23125,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23125,(1),null);
...
return cljs.core.get.call(null,arities,p1__23128_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23129_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23132){
var vec__23133 = p__23132;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23133,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23130){
var G__23131 = cljs.core.first.call(null,seq23130);
var seq23130__$1 = cljs.core.next.call(null,seq23130);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23131,seq23130__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23141__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23141__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23141__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23141__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23142 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23142,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23142,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23142,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23142,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23142,(4),null);
var arity = cljs.core.nth.call(null,vec__23142,(5),null);
...
var o__22171__auto__ = f;
return (o__22171__auto__["getBasis"]).call(o__22171__auto__);
});
/**
...
}catch (e23146){var _e__22178__auto__ = e23146;
...
var G__23147 = (obj[cljs.core.first.call(null,path)]);
var G__23148 = cljs.core.rest.call(null,path);
obj = G__23147;
path = G__23148;
continue;
} else {
...
return (function (accum,p__23149){
var vec__23150 = p__23149;
var bit = cljs.core.nth.call(null,vec__23150,(0),null);
var protocol = cljs.core.nth.call(null,vec__23150,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23153){
var vec__23154 = p__23153;
var ns = cljs.core.nth.call(null,vec__23154,(0),null);
var name = cljs.core.nth.call(null,vec__23154,(1),null);
var selector = cljs.core.nth.call(null,vec__23154,(2),null);
...
return (function (p__23158){
var vec__23159 = p__23158;
var munged_name = cljs.core.nth.call(null,vec__23159,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23159,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23159,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23157_SHARP_){
return (obj[cljs.core.first.call(null,p1__23157_SHARP_)]);
});})(name,sorted_matches,vec__23159,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1666714928077
