...
var o23076 = temp__5718__auto__;
var temp__5718__auto____$1 = (o23076["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o23077 = temp__5718__auto____$1;
return (o23077["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22188__auto__ = f;
return (o__22188__auto__["toString"]).call(o__22188__auto__);
} else {
return "";
}
}catch (e23078){var _ = e23078;
return "";
}});
...
try{var o__22188__auto___23080 = t;
(o__22188__auto___23080["cljs$lang$ctorPrWriter"]).call(o__22188__auto___23080,t,writer);
}catch (e23079){var __23081 = e23079;
}
...
var char_code = (function (){var o__22188__auto__ = (new String(char$));
return (o__22188__auto__["charCodeAt"]).call(o__22188__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22188__auto__ = String;
return (o__22188__auto__["fromCharCode"]).call(o__22188__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23082 = num_code;
switch (G__23082) {
case (1):
return (185);
...
var o__22188__auto__ = String;
return (o__22188__auto__["fromCharCode"]).call(o__22188__auto__,superscript_code);
});
/**
...
}catch (e23084){var _e__22195__auto__ = e23084;
return false;
}})())){
...
var vec__23085 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23085,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o23088 = temp__5718__auto__;
var temp__5718__auto____$1 = (o23088["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o23089 = temp__5718__auto____$1;
return (o23089["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23092){
var vec__23093 = p__23092;
var ns_detector = cljs.core.nth.call(null,vec__23093,(0),null);
...
var G__23099 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23100 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23099;
remaining_tokens = G__23100;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23090){
var G__23091 = cljs.core.first.call(null,seq23090);
var seq23090__$1 = cljs.core.next.call(null,seq23090);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23091,seq23090__$1);
});
...
var vec__23104 = cljs.core.split_with.call(null,(function (p1__23103_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23103_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23104,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23104,(1),null);
...
var vec__23110 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23110,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23110,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23113 = cljs.core.rest.call(null,remaining_tokens);
var G__23114 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23113;
name_tokens = G__23114;
continue;
} else {
...
var vec__23117 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23117,(0),null);
var arity = cljs.core.nth.call(null,vec__23117,(1),null);
var vec__23120 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23120,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23120,(1),null);
var vec__23123 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23123,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23123,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23123,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23123,(3),null);
...
var vec__23129 = result;
var munged_ns = cljs.core.nth.call(null,vec__23129,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23129,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23129,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23129,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23129,(4),null);
var arity = cljs.core.nth.call(null,vec__23129,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__23133 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__23133,(0),null);
var args = cljs.core.nth.call(null,vec__23133,(1),null);
var vec__23136 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23136,(0),null);
var name = cljs.core.nth.call(null,vec__23136,(1),null);
...
var G__23139 = (arity + (1));
var G__23140 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23141){
var vec__23142 = p__23141;
var arity = cljs.core.nth.call(null,vec__23142,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23142,(1),null);
...
return cljs.core.get.call(null,arities,p1__23145_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23146_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___23153 = arguments.length;
var i__4731__auto___23154 = (0);
while(true){
if((i__4731__auto___23154 < len__4730__auto___23153)){
args__4736__auto__.push((arguments[i__4731__auto___23154]));

var G__23155 = (i__4731__auto___23154 + (1));
i__4731__auto___23154 = G__23155;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23149){
var vec__23150 = p__23149;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23150,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23147){
var G__23148 = cljs.core.first.call(null,seq23147);
var seq23147__$1 = cljs.core.next.call(null,seq23147);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23148,seq23147__$1);
});
...
var G__23156 = arg;
var G__23156__$1 = (((G__23156 instanceof cljs.core.Keyword))?G__23156.fqn:null);
switch (G__23156__$1) {
...
var map__23158 = options;
var map__23158__$1 = (((((!((map__23158 == null))))?(((((map__23158.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23158.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23158):map__23158);
var include_ns_QMARK_ = cljs.core.get.call(null,map__23158__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23158__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23158__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23158__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23159 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23159,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23159,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23159,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23159,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23159,(4),null);
var arity = cljs.core.nth.call(null,vec__23159,(5),null);
...
var o__22188__auto__ = f;
return (o__22188__auto__["getBasis"]).call(o__22188__auto__);
});
/**
...
}catch (e23163){var _e__22195__auto__ = e23163;
...
var G__23164 = (obj[cljs.core.first.call(null,path)]);
var G__23165 = cljs.core.rest.call(null,path);
obj = G__23164;
path = G__23165;
continue;
} else {
...
return (function (accum,p__23166){
var vec__23167 = p__23166;
var bit = cljs.core.nth.call(null,vec__23167,(0),null);
var protocol = cljs.core.nth.call(null,vec__23167,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23170){
var vec__23171 = p__23170;
var ns = cljs.core.nth.call(null,vec__23171,(0),null);
var name = cljs.core.nth.call(null,vec__23171,(1),null);
var selector = cljs.core.nth.call(null,vec__23171,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__23176,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23176,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23176,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23174_SHARP_){
return (obj[cljs.core.first.call(null,p1__23174_SHARP_)]);
});})(name,sorted_matches,vec__23176,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1582568609480
